...
public class CAH {
	...
	public static int[] punkteArray = { punkte1, punkte2, punkte3, punkte4 };
	...
	public static void main(String[] args) throws IOException {
		...
		// Linie unter Titel
		JPanel linieTitel = new JPanel();
		linieTitel.setOpaque(true);
		linieTitel.setBackground(Color.WHITE);
		linieTitel.setPreferredSize(new Dimension(1, 1));
		linieTitel.setBounds(20, 80, 950, 1);
		f.add(linieTitel);
		...
		neuSchwarz.setBounds(850, 290, 125, 40);
		f.add(neuSchwarz);
	...
	public static void spielernamenanzeige(JFrame f) throws IOException {
...
//				f.add(changeNameButton);
		...
		scorename4.setBounds(850, 220, 130, 25);
		...
		changeNameButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JTextField name1eingabe = new JTextField();
				JTextField name2eingabe = new JTextField();
				...
				JOptionPane namenFenster = new JOptionPane(namenInhalt, JOptionPane.PLAIN_MESSAGE,
						JOptionPane.OK_CANCEL_OPTION, null, namenOptionen, namenOptionen[0]);
				namenFenster.createDialog(null, "Spielernamen ändern").setVisible(true);
	...
	public static void punkteMethode(JFrame f) throws IOException {

		// Punktestand einlesen
		RandomAccessFile score = new RandomAccessFile("score.txt", "rw");
	...
	private static void labelpunkte(JFrame f) {
		labelpunkte1 = new JLabel();
		labelpunkte1.setText("<html><span style='color:#fff; font-size: 12px;font-weight: 20;'>" + punkteArray[0]
				+ "</span></html>");
		...
		labelpunkte3.setText("<html><span style='color:#fff; font-size: 12px;font-weight: 20;'>" + punkteArray[2]
				+ "</span></html>");
...
//				labelpunkte3.setVisible(false);
	...
	public static void spieler2Antwort(JFrame f) throws IOException {
	...
	public static void spieler3Antwort(JFrame f) throws IOException {
